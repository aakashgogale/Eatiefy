      ...
      {phase === "expanded" ? (
        ...
        >
          <div className="flex items-center gap-2.5 rounded-xl border border-slate-200/90 bg-white dark:bg-[#1a1a1a] dark:border-gray-800 px-3 py-2 shadow-sm">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 theme-border theme-bg-soft">
              <BadgePercent className="h-4 w-4 theme-text" />
            </div>
            <div className="min-w-0 flex-1">
