        ...
        <div className="flex gap-2 sm:gap-4 md:gap-5 px-4 md:px-0 py-2">
          {categories.map((category, index) => (
            ...
            >
              ...
              <span className="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300 group-hover:text-[#1F6B45] text-center whitespace-normal max-w-[80px] sm:max-w-[100px] leading-tight line-clamp-2 transition-colors duration-300">
                {category.name}
              </span>
            </motion.div>
          ))}
