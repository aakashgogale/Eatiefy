      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 pb-24 relative z-10 overflow-y-auto">
        <div className="w-full max-w-sm flex flex-col relative -top-10 my-auto">
          ...
          <div className="mb-5 text-center flex flex-col items-center">
            ...
            <h2 className="text-[25px] font-extrabold text-[#2E7D52] dark:text-red-400 tracking-tight font-['Outfit']">
              Restaurant Partner
            </h2>
              ...
              {!isOtpStep ? (
                ...
                <div className="text-[13px] text-slate-500/90 dark:text-slate-400/90 font-['Outfit'] font-semibold tracking-[0.015em] leading-relaxed max-w-[300px] text-center mt-2 flex items-center justify-center gap-1.5 whitespace-nowrap">
                  ...
                  <button
                    ...
                    className="p-1.5 ml-1 bg-gradient-to-r from-[#2E7D52] to-[#14472F] hover:from-[#1B5E3F] hover:to-[#0E3220] rounded-[10px] text-white shadow-md shadow-[#2E7D52]/20 transition-all hover:scale-105 active:scale-95"
              ...
              {!isOtpStep ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-[#2E7D52] to-[#14472F] hover:from-[#276B47] hover:to-[#103A26] disabled:opacity-50 text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(184,11,61,0.3)] disabled:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                  >
                    {loading ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-[#2E7D52] to-[#14472F] hover:from-[#276B47] hover:to-[#103A26] disabled:opacity-50 text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(184,11,61,0.3)] disabled:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
                  >
                    {loading ? (
                  ...
                  {blockTimer > 0 && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center w-fit mx-auto px-6 py-2.5 bg-red-50 dark:bg-red-950/20 rounded-xl border border-red-100 dark:border-red-900/50 mt-4">
                      <p className="text-[11px] font-bold text-[#2E7D52] uppercase tracking-wider">
        ...
        {showRestorePopup && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="w-20 h-20 bg-[#2E7D52]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <ShieldCheck className="h-10 w-10 text-[#2E7D52]" />
              </div>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full h-14 bg-gradient-to-r from-[#2E7D52] to-[#14472F] text-white font-bold rounded-2xl shadow-xl shadow-[#2E7D52]/20 transition-all active:scale-[0.98]"
                >
                  Restore My Account
                </button>
                <button
