                ...
                {showCalendar && (
                  ...
                  <div className="relative" ref={downloadMenuRef}>
                    <button
                      ...
                      className="bg-gradient-to-br from-[#2E7D52] to-[#1B5E3F] text-white rounded-lg px-4 py-3 flex items-center justify-center gap-2 hover:bg-gray-800 transition-colors"
                    >
