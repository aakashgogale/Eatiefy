  ...
  toast.custom(
    () => (
      <div className="w-[calc(100vw-28px)] sm:w-[340px] flex items-center gap-2.5 py-2 px-3 rounded-2xl bg-white/72 dark:bg-zinc-900/72 backdrop-blur-xl border border-white/60 dark:border-white/10 shadow-[0_8px_28px_rgba(0,0,0,0.14)] ring-1 ring-black/5 animate-in fade-in slide-in-from-top-2 duration-300">
        <div className="h-10 w-10 rounded-xl bg-[#14231A] flex items-center justify-center p-0.5 shadow-md flex-shrink-0">
          <img
        ...
        >
          ...
          >
              ...
              <div className="relative group shadow-2xl">
                ...
                {isKeywordSearching && (
                  <div className="absolute right-10 top-1/2 -translate-y-1/2">
                     <div className="animate-spin rounded-full h-4 w-4 border-2 border-[#1F6B45] border-t-transparent" />
                  </div>
                )}
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-[#1a1a1a] rounded-xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden z-30 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    {keywordAddressSuggestions.map((s) => (
                      <button
                        ...
                        className="w-full px-4 py-3 flex items-start gap-3 hover:bg-[#1F6B45]/5 dark:hover:bg-[#1F6B45]/10 transition-colors text-left border-b border-gray-50 dark:border-gray-800 last:border-none"
                      >
            ...
            {mapLoading && (
              <div className="absolute inset-0 flex items-center justify-center bg-white/50 backdrop-blur-sm z-10">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#1F6B45]" />
              </div>
            )}
            ...
            <div className="absolute bottom-10 right-4 z-10 pointer-events-auto">
              ...
              >
                {mapGpsLoading ? (
                  <div className="animate-spin rounded-full h-4 w-4 border-2 border-[#1F6B45] border-t-transparent mr-2" />
                ) : (
                  <Navigation className="h-4 w-4 mr-2 text-[#1F6B45]" />
                )}
          ...
          <div className="relative bg-white dark:bg-[#0a0a0a] rounded-t-[32px] -mt-8 z-10 p-4 space-y-6 shadow-[0_-12px_24px_-10px_rgba(0,0,0,0.1)]">
            <div className="bg-[#1F6B45]/5 dark:bg-[#1F6B45]/10 border border-[#1F6B45]/10 dark:border-[#1F6B45]/20 rounded-xl p-4 flex gap-3">
               ...
               <div className="min-w-0">
                  <p className="text-xs font-bold text-[#1F6B45] dark:text-[#1F6B45]/80 uppercase mb-1">Pinnned Location</p>
            ...
            <div>
              ...
              <Input 
                ...
                className="h-12 rounded-xl border-gray-200 dark:border-gray-800 focus:ring-[#1F6B45]"
              />
            </div>
            ...
            {keywordAddressSuggestions.map((s) => {
              ...
              return (
                <button
                  ...
                  className="w-full px-4 py-3.5 flex items-start gap-3.5 hover:bg-[#1F6B45]/5 dark:hover:bg-[#1F6B45]/10 transition-colors text-left"
                >
                  <div className="h-9 w-9 rounded-full bg-red-50 dark:bg-red-950/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <MapPin className="h-4.5 w-4.5 text-[#1F6B45]" />
                  </div>
        ...
        <div className="bg-white dark:bg-[#0a0a0a] border-b border-zinc-100 dark:border-zinc-800/60 divide-y divide-zinc-100 dark:divide-zinc-800/40">
          ...
          >
            <div className="h-10 w-10 rounded-full bg-red-50 dark:bg-red-950/10 flex items-center justify-center flex-shrink-0">
              <Crosshair className="h-5 w-5 text-[#1F6B45]" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-bold text-[#1F6B45] text-[15px]">Use current location</p>
          ...
          >
            <div className="h-10 w-10 rounded-full bg-red-50 dark:bg-red-950/10 flex items-center justify-center flex-shrink-0">
              <Plus className="h-5 w-5 text-[#1F6B45]" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-bold text-[#1F6B45] text-[15px]">Add Address</p>
            </div>
            <ChevronRight className="h-5 w-5 text-zinc-300 dark:text-zinc-600 flex-shrink-0" />
          </button>
        </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 min-w-0">
                          ...
                          <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[#1F6B45]/10 flex-shrink-0">
                            <ChevronRight className="h-4 w-4 text-[#1F6B45]" strokeWidth={2.5} />
                          </span>
                        </div>
                    ...
                    <div className="flex flex-col gap-1.5 pt-1 flex-shrink-0">
                      <button
                        ...
                        className="h-9 w-9 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-500 hover:text-[#1F6B45] hover:border-[#1F6B45]/30 transition-colors"
