...
export function installNativeApiErrorBridge() {
  if (typeof window === "undefined") return;
  if (window.__eatiefyNativeApiErrorBridgeInstalled) return;
  window.__eatiefyNativeApiErrorBridgeInstalled = true;
  ...
  window.eatiefyOnNativeApiError = handlePayload;
  window.handleNativeApiError = handlePayload;
  window.showApiErrorToast = handlePayload;
  window.__eatiefyHandleNativeApiError = handlePayload;
  ...
  window.addEventListener("eatiefy:native-api-error", (event) => {
